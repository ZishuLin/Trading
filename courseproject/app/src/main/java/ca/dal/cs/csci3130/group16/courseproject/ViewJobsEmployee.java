...
public class ViewJobsEmployee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(ViewJobsEmployee.this));
                recyclerView.setAdapter(new ViewAdapterEmployee(getApplicationContext(), filtered));
            }
