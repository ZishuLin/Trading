...
public class ViewAdapter extends RecyclerView.Adapter<JobViewEmployerHolder> {
    Context context;
    List<Job> jobs;
    Geocoder geocoder;
    List<Address> addresses;

    public ViewAdapter(Context context, List<Job> jobs) {
    ...
    @NonNull
    @Override
    public JobViewEmployerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new JobViewEmployerHolder(LayoutInflater.from(context).inflate(R.layout.job_view_employer, parent, false));
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull JobViewEmployerHolder holder, int position) {
        ...
        holder.hasEmployee = jobs.get(position).isOpen;
